...
intents_files = open("C:/Users/Shadow/Documents/chatbot_brief_simplon/model/ressources/intents/intents3.json",encoding='utf-8').read()
intents = json.loads(intents_files)
lemmatizer = WordNetLemmatizer
stop_words = set(stopwords.words('french')) 
sent_tokenize = nltk.data.load('tokenizers/punkt/french.pickle')
special_characters = r'[^A-Za-àéèùêôûâïäëç]+'
...
######################################################################################################################################################################################################
    ...
    def save(self):
        ...
        for element in list_elements:
            with open(f'C:/Users/Shadow/Documents/final_chat_bot/chatbot_brief_simplon/backend/app/model/ressources/obj/{list_name_save[i]}.pkl', 'wb') as f:
    ...
    def read_file(self,file_name):
            ...
            with open(f'C:/Users/Shadow/Documents/final_chat_bot/chatbot_brief_simplon/backend/app/model/ressources/obj/{file_name}.pkl', 'rb') as f:
