...
class bot:
    ...
    def __init__(self):
        ...
        self.intents_files = json.loads(open("C:/Users/Shadow/Documents/Chatbot_pour_l_ecole_Microsoft_IA_Brest//chatbot_brief_simplon/Luigi/ressources/intents/intents.json",encoding='utf-8').read())
        self.model = load_model('C:/Users/Shadow/Documents/Chatbot_pour_l_ecole_Microsoft_IA_Brest/chatbot_brief_simplon/Luigi/model/chatbot_model.h5')
